...
import { HomeIcon, MapPinPlusIcon, Trash2Icon } from "lucide-react";
    ...
    <section className="rounded-[30px] border border-stone-900/10 bg-white/85 p-5 shadow-[0_30px_90px_-55px_rgba(41,37,36,0.75)] backdrop-blur">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-7 text-stone-600">
            自宅住所と保存地点を管理する。移動ブロック作成時の候補になる。
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-[0.8fr_1.4fr_auto]">
        ...
        <button
          ...
          onClick={addLocation}
          disabled={isPending}
          className="inline-flex items-center justify-center rounded-full bg-stone-900 px-4 py-3 text-sm font-medium text-stone-50"
        >

  ...
  return (
    ...
    >
      <section className="grid h-full min-h-0 gap-4 lg:grid-cols-[280px_minmax(0,1fr)]">
        ...
        <section className="flex min-h-0 flex-col overflow-hidden rounded-[32px] border border-stone-900/10 bg-[linear-gradient(180deg,_rgba(35,31,32,0.98),_rgba(54,48,42,0.94))] shadow-[0_30px_90px_-50px_rgba(28,25,23,0.9)]">
